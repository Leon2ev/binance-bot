...
set_price = open_price + open_price / 19
koef_usdt = 1.2
koef_price = 7
koef_fix = 10
...
print(usdt_1, usdt_2, usdt_3, usdt_4, usdt_5)
...
print(amount_1, amount_2, amount_3, amount_4, amount_5)
...
print(usdt1, usdt12, usdt123, usdt1234, usdt12345)
...
print(buy1, buy12, buy123, buy1234, buy12345)
...
print(fix1, fix2, fix3, fix4, fix5)
